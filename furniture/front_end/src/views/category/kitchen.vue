...
export default {
  ...
  data() {
    return {
      ...
      img_banner: "kitchen_category.jpg",
      products: [],
    };
  },
  computed: {
  ...
  methods: {
    ...
    ...mapGetters(["ProductsKitchen"]),
    getProducts() {
      let products_kitchen = this.ProductsKitchen();
      this.products = products_kitchen.products;
    },
    formatPrice(value) {

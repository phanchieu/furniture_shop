          ...
          <div class="banner_and_product col-12 col-lg-9">
            <div class="banner">
              <img
                ...
                alt=""
              />
              <div class="title"><h1>Phòng ngủ</h1></div>
            </div>
            <div class="filter">
              <span>Sắp xếp</span>
...
export default {
  ...
  data() {
    return {
      ...
      img_banner: "bedroom_category.jpg",
      products: [],
    };
  },
  computed: {
  ...
  methods: {
    ...
    getProducts() {
      let products_bedroom = this.ProductsBedRoom();
      this.products = products_bedroom.products;
      // console.log(products_bedroom)
    },
    formatPrice(value) {

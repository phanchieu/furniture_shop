          ...
          <div class="banner_and_product col-12 col-lg-9">
            <div class="banner">
              <img
                ...
                alt=""
              />
              <div class="title"><h1>đồ trang trí</h1></div>
            </div>
            <div class="filter">
              <span>Sắp xếp</span>
...
export default {
  ...
  data() {
    return {
      ...
      img_banner: "decoration_category.jpg",
      products: [],
    };
  },
  computed: {
  ...
  methods: {
    ...
    ...mapGetters(["productsDecoration"]),
    getProducts() {
      let products_decorations = this.productsDecoration();
      this.products = products_decorations.products;
    },
    formatPrice(value) {
